...
while True:
    cube.clear()
    cube.set_pixel(0,0,0, (255,0,0)) # FBL RED
    cube.set_pixel(7,0,0, (0, 255, 0)) # FBR GREEN
    cube.set_pixel(0,7,0, (0,0, 255)) #FTL BLUE
    cube.set_pixel(0,0,7, (0, 255, 255)) #BBL CYAN
